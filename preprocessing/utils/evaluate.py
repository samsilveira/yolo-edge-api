...
DATASET_YAML = str(REPO_ROOT / "dataset/exports/epi-v1/data.yaml")
MODEL_PATH   = str(REPO_ROOT / "models/yolov8n.pt")
...
def evaluate_pipeline(
    ...
    if preprocess_fn is None:
        ...
        tmp_root = REPO_ROOT / "preprocessing/outputs/_tmp_eval" / safe_label
        if tmp_root.exists():
